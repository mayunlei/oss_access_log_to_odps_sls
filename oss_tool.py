...
if __name__ == "__main__": 
    ...
    parser.add_option("","--to_mysql" ,dest="send_log_to_mysql",help="if --to_mysql is set in CLI,log will send to mysql",action="store_true")
    ...
    if option.access_id is not None  or  option.access_key is not None :
        oss_access_id = sls_access_id = option.access_id
        oss_access_key = sls_access_key = option.access_key
    else :
